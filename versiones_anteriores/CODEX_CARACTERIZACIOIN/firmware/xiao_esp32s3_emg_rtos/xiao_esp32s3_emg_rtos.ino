/*
  ...
  Lee 4 sensores EMG y envia CSV por USB Serial:
  timestamp_ms,sample_index,emg_ch1,emg_ch2,emg_ch3,emg_ch4,board_id,sampling_rate_hz

  Esta version separa la adquisicion ADC de la transmision serial usando una
  cola FreeRTOS. Es una base para luego agregar una tarea de inferencia con
  TensorFlow Lite Micro.
*/

#include <Arduino.h>

static const char* BOARD_ID = "xiao_esp32s3_rtos";

static const int NUM_CHANNELS = 4;
static const int EMG_PINS[NUM_CHANNELS] = {A1, A2, A3, A4};

static const uint32_t SERIAL_BAUD = 921600;
static const uint16_t SAMPLING_RATE_HZ = 1000;
static const uint32_t SAMPLE_PERIOD_TICKS = pdMS_TO_TICKS(1);
