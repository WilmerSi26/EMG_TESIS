...
DATA_RAW_DIR = PROJECT_ROOT / "data" / "final_10clases"
DEFAULT_LOW_CUT_HZ = 10.0
DEFAULT_HIGH_CUT_HZ = 90.0
...
RUTINA = [
    ...
    ("pulgar_cierre", 5),
    ("reposo", 2),
    ("indice_medio_apertura", 5),
    ("reposo", 2),
    ("indice_medio_cierre", 5),
    ("reposo", 2),
    ("anular_menique_apertura", 5),
    ("reposo", 2),
    ("anular_menique_cierre", 5),
    ("reposo", 2),
    ("pinza", 6),
    ("reposo", 5),
]
...
PHASE_DISPLAY = {
    ...
    "apertura": "APERTURA MANO",
    "cierre": "CIERRE MANO",
    "pulgar_apertura": "APERTURA PULGAR",
    "pulgar_cierre": "CIERRE PULGAR",
    "indice_medio_apertura": "APERTURA INDICE-MEDIO",
    "indice_medio_cierre": "CIERRE INDICE-MEDIO",
    "anular_menique_apertura": "APERTURA ANULAR-MENIQUE",
    "anular_menique_cierre": "CIERRE ANULAR-MENIQUE",
    "pinza": "PINZA FINA",
}
...
class EMGRecorderApp:
    def __init__(self, root: tk.Tk) -> None:
        self.root = root
        self.root.title("Captura sEMG funcional 10 clases - XIAO 200 Hz")
        ...
        self.filter_status_var = tk.StringVar(value="Filtro: pasa banda 10-90 Hz + notch 60 Hz")
    ...
    def iniciar_grabacion(self) -> None:
        ...
        filename = f"{timestamp}_{subject_id}_trial-{trial_number}_funcional_10clases_4ch_200hz.csv"
